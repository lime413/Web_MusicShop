...
namespace Web_music_feb_jun2024.Controllers
{
    ...
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Manufacturer,Price,Rating,Img,Articul")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Manufacturer,Price,Rating,Img,Articul")] Instrument instrument)
        {
            if (id != instrument.Id)
            {
                return NotFound();
